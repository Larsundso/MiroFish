              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge {{ t('step5.insightForge') }}</div>
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch {{ t('step5.panoramaSearch') }}</div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch {{ t('step5.quickSearch') }}</div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent {{ t('step5.interview') }}</div>
                    <div class="tool-desc">{{ t('step5.interviewDesc') }}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ t('step5.selectTargets') }}</span>
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection">{{ t('step5.clearAll') }}</button>
              </div>
            </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              ...
              <span class="results-count">{{ surveyResults.length }} {{ t('step5.replies') }}</span>
            </div>
