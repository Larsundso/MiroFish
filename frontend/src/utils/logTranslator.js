...
const LOG_PHRASES = [
  ...
  ['获取模拟上下文', 'Fetching simulation context'],
  ['图谱搜索', 'Graph search'],
  ['报告文件夹已删除', 'Report folder deleted'],
  ['降级为本地搜索', 'Falling back to local search'],
  ['使用本地搜索', 'Using local search'],
  ['获取到', 'Fetched'],
  ['条边', ' edges'],
  ['个节点', ' nodes'],
  ['本地搜索完成', 'Local search complete'],
  ['找到', 'Found'],
  ['条相关事实', ' relevant facts'],
  ['搜索完成', 'Search complete'],
  ['获取节点详情', 'Fetching node details'],
  ['InsightForge完成', 'InsightForge complete'],
  ['条事实', ' facts'],
  ['个实体', ' entities'],
  ['条关系', ' relations'],
  ['时序记忆中所关联的最新关键事实', 'Latest key facts from temporal memory'],
  ...
  ['正在读取边数据', 'Reading edge data'],
  ['实体读取完成', 'Entity reading complete'],
  ['筛选符合条件的实体', 'Filtering matching entities'],
  ['生成Agent profile', 'Generating agent profile'],
  ['开始生成...', 'Starting generation...'],
  ['已完成', 'Completed'],
  ['正在调用LLM生成配置', 'Calling LLM to generate config'],
  ['生成模拟配置', 'Generating simulation config'],
  ['生成Agent配置', 'Generating agent config'],
  ['初始激活编排', 'Initial activation orchestration'],
  ['生成初始帖子', 'Generating initial posts'],
